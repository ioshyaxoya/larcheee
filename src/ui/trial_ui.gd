...
func _init() -> void:
	...
	title_label.add_theme_font_override("font", GameTheme.stage_font())
	title_label.add_theme_color_override("font_color", GameTheme.TEXT_DIM)
	box.add_child(title_label)
	hours_label = Label.new()
	hours_label.add_theme_font_override("font", GameTheme.clock_font())
	hours_label.add_theme_font_size_override("font_size", 24)
	hours_label.add_theme_color_override("font_color", GameTheme.GOLD)
	...
	argument_label.add_theme_font_size_override("normal_font_size", 20)
	...
	rhythm_bar.custom_minimum_size = Vector2(0, 3)
